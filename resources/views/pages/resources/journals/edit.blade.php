<x-app-layout>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid" style="background-color: #f6f6f6;}">
        ...
        <div id="kt_app_content_container" class="app-container container-fluid" style="padding-left: 0px!important; padding-right: 0px!important">
            <!--begin::Card-->
            <div class="card">
            <form id="kt_modal_add_user_form" class="form px-5" action="{{ route('journals.update', ["journal" => $journal]) }}" method="POST">
                @csrf
                @method("patch")
                  <div class="card-body py-4">
                    ...
                    <div class="mb-7">
                        ...
                        <input type="text" name="content" id="content"
                            class="form-control form-control-solid mb-3 mb-lg-0 {{ $errors->get("content") ? "is-invalid border border-1 border-danger" : "" }}" placeholder="Journal Content"
